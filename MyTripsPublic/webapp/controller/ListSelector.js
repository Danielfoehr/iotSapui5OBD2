sap.ui.define([
	...
	return BaseObject.extend("Vorlage.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias Vorlage.model.ListSelector
		 */
		 ...
		 * @return {Vorlage.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
